...
<div class="w3-container">
	...
	<form method="POST" action="/camp24/qnaBoard/qnaBoardEditProc.cmp" name="frm" id="frm"
		...
		<input type="hidden" name="qno" value="${DATA.qno}">
		...
		<div class="w3-rest w3-padding w3-border-left">
				<div class="w3-col w3-border-gray">
					...
					<input name="title" id="title" class="w3-col w3-padding ft12 w3-border" value="${DATA.title}">
				</div>
				<div class="w3-col w3-margin-top">
					<label for="body"><small><strong>내용</strong></small></label>
					<textarea name="body" id="body" class="w3-col w3-padding ft12 w3-border" style="resize: none; height: 100%;">${DATA.body}</textarea>
					</div>
				</div>
